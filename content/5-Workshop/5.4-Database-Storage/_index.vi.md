...
![Danh sách bảng DynamoDB](/images/5-Workshop/5.4-Database-Storage/15.png)
...
![Table đã tạo](/images/5-Workshop/5.4-Database-Storage/17.png)
...
![Trạng thái table ACTIVE](/images/5-Workshop/5.4-Database-Storage/18.png)
...
![Tổng quan S3 buckets](/images/5-Workshop/5.4-Database-Storage/19.png)
...
![Bucket frontend đã tạo](/images/5-Workshop/5.4-Database-Storage/21.png)

**Bước 2:** Enable Static Website Hosting

![Bucket properties](/images/5-Workshop/5.4-Database-Storage/22.png)
![Cấu hình static website hosting](/images/5-Workshop/5.4-Database-Storage/23.png)
![Static website hosting đã bật](/images/5-Workshop/5.4-Database-Storage/24.png)
...
![Bucket receipts](/images/5-Workshop/5.4-Database-Storage/25.png)
...
![Tổng quan Secrets Manager](/images/5-Workshop/5.4-Database-Storage/28.png)
...
![Key/value của secret](/images/5-Workshop/5.4-Database-Storage/30.png)
...
![Kiểm tra DynamoDB qua CLI](/images/5-Workshop/5.4-Database-Storage/30.1.png)
