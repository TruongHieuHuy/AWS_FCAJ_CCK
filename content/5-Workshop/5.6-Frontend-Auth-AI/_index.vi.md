...
![Tổng quan Cognito](/images/5-Workshop/5.6-Frontend-Auth-AI/45.png)

**Bước 1:** AWS Console → Cognito → User pools → Create user pool

![Create user pool](/images/5-Workshop/5.6-Frontend-Auth-AI/46.png)
![Authentication providers](/images/5-Workshop/5.6-Frontend-Auth-AI/47.png)
...
![App integration](/images/5-Workshop/5.6-Frontend-Auth-AI/48.png)
![Create app client](/images/5-Workshop/5.6-Frontend-Auth-AI/49.png)
...
![Cognito auth service](/images/5-Workshop/5.6-Frontend-Auth-AI/50.png)
...
![Login component](/images/5-Workshop/5.6-Frontend-Auth-AI/51.png)
