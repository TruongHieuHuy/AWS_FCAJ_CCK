...
![Search for IAM in the console](/images/5-Workshop/5.2-Prerequisites/0.png)

Go to IAM → Users → Create user

![IAM users list, Create user](/images/5-Workshop/5.2-Prerequisites/1.png)

- User name: `budget-tracket-dev`

![User details form](/images/5-Workshop/5.2-Prerequisites/2.png)

**Step 3: Grant permissions to the IAM User**

![Grant permissions](/images/5-Workshop/5.2-Prerequisites/3.png)

**Step 4: Create Access Keys**

![Create access keys](/images/5-Workshop/5.2-Prerequisites/4.png)
![Access key details](/images/5-Workshop/5.2-Prerequisites/5.png)
![Access key confirmation](/images/5-Workshop/5.2-Prerequisites/6.png)
...
![Local tools installed](/images/5-Workshop/5.2-Prerequisites/7.png)
