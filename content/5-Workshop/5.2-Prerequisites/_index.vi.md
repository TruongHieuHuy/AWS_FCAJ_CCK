...
![Tìm kiếm IAM trong console](/images/5-Workshop/5.2-Prerequisites/0.png)

Vào IAM → Users → Create user

![Danh sách IAM users, Create user](/images/5-Workshop/5.2-Prerequisites/1.png)

- User name: `budget-tracket-dev`

![Form User details](/images/5-Workshop/5.2-Prerequisites/2.png)

**Bước 3: Gán quyền cho IAM User**

![Gán quyền](/images/5-Workshop/5.2-Prerequisites/3.png)

**Bước 4: Tạo Access Keys**

![Tạo access keys](/images/5-Workshop/5.2-Prerequisites/4.png)
![Chi tiết access key](/images/5-Workshop/5.2-Prerequisites/5.png)
![Xác nhận access key](/images/5-Workshop/5.2-Prerequisites/6.png)
...
![Cài đặt công cụ local](/images/5-Workshop/5.2-Prerequisites/7.png)
