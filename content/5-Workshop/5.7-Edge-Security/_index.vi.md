...
![API Gateway console](/images/5-Workshop/5.7-Edge-Security/52.png)

AWS Console → API Gateway → Select `BudgetTracketAPI`

![Menu Authorizers](/images/5-Workshop/5.7-Edge-Security/53.png)
...
![Gắn authorizer vào method](/images/5-Workshop/5.7-Edge-Security/54.png)
...
![Cấu hình authorizer trong SAM template](/images/5-Workshop/5.7-Edge-Security/55.png)
...
![Code trích xuất claims](/images/5-Workshop/5.7-Edge-Security/56.png)
![Sử dụng claims](/images/5-Workshop/5.7-Edge-Security/57.png)
...
![Enable CORS kèm authorizer](/images/5-Workshop/5.7-Edge-Security/58.png)
...
![Danh sách CloudFront distributions](/images/5-Workshop/5.7-Edge-Security/59.png)

**Bước 1:** AWS Console → CloudFront → Create distribution

![Create distribution](/images/5-Workshop/5.7-Edge-Security/60.png)
![Origin access control](/images/5-Workshop/5.7-Edge-Security/61.png)
...
![Cấu hình behavior](/images/5-Workshop/5.7-Edge-Security/62.png)
...
![Route 53 A record](/images/5-Workshop/5.7-Edge-Security/63.png)
